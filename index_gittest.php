<?php
/************************************************************************
				VERSION 1.0 RELEASE FOR SEASONWATCH.IN
************************************************************************/					 
            ...
            <div class="body_top1"><!--  start main  -->
				...
				You can select from a list of <a href = "javascript:void(0)" 
                                onclick = "document.getElementById('25focallist').style.display='block';
                                    document.getElementById('fade').style.display='block';window.scrollTo(0, 0);" ><span class="red">25 focal species</a>, but are also
